...
resource "aws_iam_role" "codebuild" {
  name_prefix        = "aurex-catalog-build-"
    ...
    Statement = [
      {
        ...
        Resource = "arn:${local.partition}:logs:${local.region}:${local.account_id}:log-group:/aws/codebuild/aurex-catalog-*"
      },
      {
        Sid      = "Artifacts"
        Effect   = "Allow"
...
resource "aws_iam_role" "pipeline" {
  name_prefix        = "aurex-catalog-pipeline-"
